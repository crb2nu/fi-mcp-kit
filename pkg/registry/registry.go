...
// GetRepoRoot returns the workspace root path for resolving ${repo} tokens.
//
// Priority:
...
// FindDefaultPath returns the default registry path in a workspace.
...
// 2. Home directory default: ~/.config/fi-mcp/registry.yaml
// 3. Legacy home directory default: ~/.config/loom/registry.yaml
// 4. Legacy workspace paths as fallback
...
func FindRegistry() (string, bool) {
	...
	candidates := []string{
		...
		filepath.Join(home, ".config", "fi-mcp", "registry.yaml"),
